...
import com.nareshgediya.instagram.Fragments.PostDetailFragment;
import com.nareshgediya.instagram.Fragments.ProfileFragment;
import com.nareshgediya.instagram.Models.Notification;
            ...
            public void onClick(View v) {
                if (notification.isIsPost()) {
                    ...
                    ((FragmentActivity)mContext).getSupportFragmentManager()
                            .beginTransaction().replace(R.id.container_fragment, new PostDetailFragment()).commit();
                } else {
                    mContext.getSharedPreferences("PROFILE", Context.MODE_PRIVATE)
                            .edit().putString("profileId", notification.getUserid()).apply();

                    ((FragmentActivity)mContext).getSupportFragmentManager()
                            .beginTransaction().replace(R.id.container_fragment, new ProfileFragment()).commit();
                }
            }
        });
